...
jQuery(function() {
    jQuery('#output').qrcode({
        render   : "canvas",
		correctLevel : qr.QRErrorCorrectLevel.M,
		foreground   : c||"#000",
		background   : bg||"#fff",
		width        : w,
	    height       : h,
...
*/
;define('jq/qrlogo', ['jquery3'], function(require, exports, module){
...
//来源： http://files.cnblogs.com/files/frlmoney/jquery.qrcode.min.js
